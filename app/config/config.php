...
|--------------------------------------------------------------------------
|
| Little nifty language detection script which also sets proper CI locale
*/
/*if (stripos($_SERVER['HTTP_ACCEPT_LANGUAGE'], 'ru-RU') !== FALSE) {
...
$config['csrf_token_name'] = 'nocsrf_please';
$config['csrf_cookie_name'] = 'csrf_passport';
...
/*
| Autoloading models, controllers and libraries in order to provide ability of proper PHP extendings.
| Thanks to Burak Guzel for the tip!
*/
